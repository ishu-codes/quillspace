...
const USERS = [
  { name: "Aarav Sharma", email: "aarav.sharma@email.com", password: "aarav1234" },
  { name: "Neha Verma", email: "neha.verma@email.com", password: "neha1234" },
  { name: "Rohan Mehta", email: "rohan.mehta@email.com", password: "rohan1234" },
  { name: "Priya Nair", email: "priya.nair@email.com", password: "priya1234" },
];
...
async function signup(user: (typeof USERS)[number]) {
