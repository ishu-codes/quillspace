	...
	const users = [
		{
			...
			posts: [
				{
					title: "Building a Ticketing System: Concurrency, Locks, and Race Conditions",
					desc: "Lessons learnt after working with agents for over an year.",
					featuredImg: "https://miro.medium.com/v2/resize:fit:1100/format:webp/1*XdhspB1zG5ByRO2NlzIreg.png",
			...
			posts: [
				{
					...
					featuredImg: "https://miro.medium.com/v2/resize:fit:1100/format:webp/1*Gy3uJTUwaEb2XuNCYfBSLw.png",
				...
				},
				{
					...
					featuredImg: "https://miro.medium.com/v2/resize:fit:1100/format:webp/1*w6vi8U5ghMB4kUWXSk9TAA.png",
			...
			posts: [
				{
					...
					featuredImg: "https://miro.medium.com/v2/resize:fit:1100/format:webp/1*mrKawyepnNmoK8UTm0IIsw.png",
			...
			posts: [
				{
					...
					featuredImg: "https://miro.medium.com/v2/resize:fit:1100/format:webp/1*tAJ-QxKPO53osRHO8vcfOw.jpeg",
			...
			posts: [
				{
					...
					featuredImg: "If there is one thing I am addicted to, besides coffee, it is the internet.",
			...
			posts: [
				{
					...
					featuredImg: "https://miro.medium.com/v2/resize:fit:1100/format:webp/0*sRe9SSSWZH8aQWHH.jpg",
			...
			posts: [
				{
					...
					featuredImg: "https://miro.medium.com/v2/resize:fit:1100/format:webp/1*NybUdowBAV76fcQKbmOrNA.png",
			...
			posts: [
				{
					...
					featuredImg: "https://miro.medium.com/v2/resize:fit:1100/format:webp/1*NYO7c5_nGSPyHO0Ay4bbCw.png",
